...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'X4jVVeEzz8wACoRoJD8LTw8J-vPInjtDRGh1sNhzMLg',
      ...
      festivals: [
        ...
        {
          type: '节日', name: '相识纪念日', year: '2024', date: '03-18',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: 'X4jVVeEzz8wACoRoJD8LTw8J-vPInjtDRGh1sNhzMLg',
